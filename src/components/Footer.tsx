    ...
    <footer className="relative w-full bg-azul-institucional px-6 md:px-12 py-16 md:py-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-16">
          ...
          {/* Column 2: EMPRESA */}
          <div>
            <h3 className="text-white font-bold text-lg mb-4 uppercase">EMPRESA</h3>
            <ul className="space-y-3">
              <li>
                <a href="#inicio" className="text-white hover:text-amarillo-constructor transition-colors text-sm">
                  Inicio
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#reseñas" className="text-white hover:text-amarillo-constructor transition-colors text-sm">
                  Reseñas
                </a>
              </li>
              <li>
                <a href="#contacto" className="text-white hover:text-amarillo-constructor transition-colors text-sm">
                  Contacto
                </a>
              </li>
            </ul>
